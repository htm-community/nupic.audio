...
if __name__ == "__main__":
  ...
  # Test the classifier with unheard "One" variations pre-mixed with noise
  test_names = []
  test_names.append(datapath + "1_jackson_1.ngm.npy")
  test_names.append(datapath + "1_jackson_1_n5.ngm.npy")
  test_names.append(datapath + "1_jackson_1_n10.ngm.npy")
  test_names.append(datapath + "1_jackson_1_n25.ngm.npy")
  test_names.append(datapath + "1_jackson_1_n50.ngm.npy")
  ...
  ax.set_xlabel('Additive noise amount')
